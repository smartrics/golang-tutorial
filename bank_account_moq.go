...
func (mock *BankAccountMock) Deposit(amount float64) (BankAccount, error) {
...
// ID calls IDFunc.
func (mock *BankAccountMock) ID() AccountID {
	if mock.IDFunc == nil {
...
func (mock *BankAccountMock) Withdraw(amount float64) (BankAccount, error) {
